function GitCalendarInit(git_gitapiurl, git_color, git_user) {
  if (document.getElementById('git_container')) {
    var git_canlendar = (git_user, git_gitapiurl, git_color) => {
      var git_fixed = 'fixed';
      var git_px = 'px';
      var git_month = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
      var git_monthchange = [];
      ...
      var responsiveChart = () => {
        if (document.getElementById("gitcanvas")) {
          ...
          if (document.body.clientWidth > 700) {
            ...
            git_calendar_ctx.fillText("Thứ", 0, 1.9 * linemaxwitdh);
            git_calendar_ctx.fillText("Hai", 0, 3.9 * linemaxwitdh);
            git_calendar_ctx.fillText("Tư", 0, 5.9 * linemaxwitdh);
            git_calendar_ctx.fillText("Sáu", 0, 7.9 * linemaxwitdh);
      ...
      var git_info_box = (user, color) => {
        ...
        html += `<div id="git_tooltip_container"></div>
                        <div class="contrib-footer clearfix mt-1 mx-3 px-3 pb-1">
                          <div class="float-left text-gray">Nguồn dữ liệu
